...
**Per Digit Peformance Analysis:**

```{python confusion-matrices}
plot_confusion_matrices(knn_model, nn_model, X_test, y_test)
```

This detailed analysis shows that the Neural Network consistently outperforms KNN across all digits, especially for more complex digits like 8 and 9.
