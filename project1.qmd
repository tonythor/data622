...
<p style="text-align: center;">
    <a href=https://github.com/tonythor/data622 target=_blank>Github</a> &nbsp; | &nbsp; <a href=https://rpubs.com/tonythor/data622-project1 target=_blank>Web Presentation</a>
</p>
...
# Generate the boxplot and encode it in Base64
...
xgb.plot_importance(best_model, importance_type='weight', max_num_features=20, ax=ax)
...
## Sources
* <a href=https://survey.stackoverflow.co target=_blank>Stack Overvlow Developer Survey</a>
* <a href=https://github.com/tonythor/data622/blob/main/lussi/ziprecruiter.py target=_blank> Our Zip Recruiter Data Downloader</a>
