...
2. **Review project 2:predictions, effectiveness**  

3. **Run the similar workflow, except through SVM**  
...
## Project 2, Random Forest Review
...
## Running the model with dedicated SVM adjustments.
For this, we've made several SVM specific modifications we will cover in the comparison section. 
